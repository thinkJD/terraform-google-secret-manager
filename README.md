...
| <a name="input_rotation_policy"></a> [rotation\_policy](#input\_rotation\_policy) | n/a | <pre>object({<br>    rotation_period    = string<br>    next_rotation_time = number<br>  })</pre> | <pre>{<br>  "next_rotation_time": 1000,<br>  "rotation_period": "30d"<br>}</pre> | no |
